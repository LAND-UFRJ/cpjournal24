...
def adjust_box(ax: plt.Axes):
    ...
    patches[7].set_y(3)
    patches[9].set_y(5-1/6)
    #patches[5].set_y(5-1/6)
...
ax[0].set_xticks(np.arange(0,4500,500))
ax[0].set_xlim([0,4000])
ax[0].set_xticklabels(['0', '', '1000', '', '2000', '', '3000', '', '4000'])
...
ax = fig.subplot_mosaic([['legend', 'legend', 'legend'],[0,1,2], [3,4,5]], 
