...
file = 'e45f01b4bb1e_rnp_rj_d_throughput.txt'
...
p_thr = 0.5         # threshold probability to an window decide for a changepoint
pa_thr = 0.8       # threshold probabilty to decide for a changepoint
